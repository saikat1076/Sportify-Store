    ...
    <footer className="bg-[#1D2D50] text-white py-12">
      <div className="mx-auto px-6">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h2 className="text-3xl font-bold">Sportify Shop</h2>
            <p className="text-sm mt-2">© 2024 Sportify Shop. All Rights Reserved.</p>
          </div>
          
          <div>
            <h3 className="font-semibold text-lg">Contact Us</h3>
            <p className="text-sm">Email: contact@Sportify.com</p>
        ...
        <div className="border-t border-blue-600 pt-6 text-center">
          <p className="text-sm">© 2024 Sportify Shop. All Rights Reserved. Powered by [Your Company].</p>
        </div>
      </div>
    </footer>
  );
